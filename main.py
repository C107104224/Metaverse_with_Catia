...
class Main_Frame:
    def __init__(self, master):
        ...
        self.text1 = tk.Label(self.master, text='20220126', font=("Arial", 16), anchor='center')
        self.text1.grid(row=0, column=0, columnspan=5, padx=5, sticky='we')
        self.text2c = tk.Label(self.master, text='1.型號(Scale): ', font=("Arial", 12), anchor='w')
        self.text2c.grid(row=1, column=0, columnspan=5, sticky='w')
        self.text2d = tk.Label(self.master, text='2.版型(version): ', font=("Arial", 12), anchor='w')
        self.text2d.grid(row=3, column=0, columnspan=5, sticky='w')
        self.text2 = tk.Label(self.master, text='3. 長(Length): ', font=("Arial", 12), anchor='w')
        self.text2.grid(row=5, column=0, columnspan=5, sticky='w')
        self.text2a = tk.Label(self.master, text='4. 寬(Width): ', font=("Arial", 12), anchor='w')
        self.text2a.grid(row=7, column=0, columnspan=5, sticky='w')
        self.text2b = tk.Label(self.master, text='5. 高(Height): ', font=("Arial", 12), anchor='w')
        self.text2b.grid(row=9, column=0, columnspan=5, sticky='w')
        ...
        self.button3 = tk.Button(self.master, text='匯入參數\nSet Value',
                                 command=lambda: [self.confirm_data, mprog.File_open(self.box2.get(),
                                                                                     folderdir + "%s\\" % (
                                                                                         self.box.get()))])
        self.button3.grid(row=6, column=4, padx=5)
